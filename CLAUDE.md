...
- **Always screenshot from localhost:** `http://localhost:4321` — note: `screenshot.mjs` only exists in `archive/`, not the project root.
...
## Brand Assets
- Always check the `archive/` folder for brand images (`Brand Guidelines_1.png`, `Brand Guidelines_2.png`, `home_content.png`) before designing.
